...
public class CutVideoWindow : Window
{
    ...
    private static Border MakeSubtitlesView(CutVideoViewModel vm)
    {
    ...
    private static Border MakeVideoSettingsView(CutVideoViewModel vm)
    {
    ...
    private static Border MakeCutView(CutVideoViewModel vm)
    {
    ...
    private static Border MakePreviewView(CutVideoViewModel vm)
    {
    ...
    private static Border MakeBatchView(CutVideoViewModel vm)
    {
    ...
    private static Border MakeVideoInfoView(CutVideoViewModel vm)
    {
