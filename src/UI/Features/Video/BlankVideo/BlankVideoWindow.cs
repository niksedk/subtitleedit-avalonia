...
public class BlankVideoWindow : Window
{
    ...
    private static Border MakeSubtitlesView(BlankVideoViewModel vm)
    {
    ...
    private static Border MakeCutView(BlankVideoViewModel vm)
    {
    ...
    private static Border MakePreviewView(BlankVideoViewModel vm)
    {
    ...
    private static Border MakeBatchView(BlankVideoViewModel vm)
    {
    ...
    private static Border MakeVideoInfoView(BlankVideoViewModel vm)
    {
