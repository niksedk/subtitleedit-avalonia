...
namespace Nikse.SubtitleEdit.Features.Shared.FormatProperties.RosettaProperties;
...
public class RosettaPropertiesWindow : Window
{
    ...
    private Border MakeFontsView(RosettaPropertiesViewModel vm)
    {
    ...
    private static Border MakePreviewView(RosettaPropertiesViewModel vm)
    {
        var grid = new Grid
        {
            RowDefinitions =
