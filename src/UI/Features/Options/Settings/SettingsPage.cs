...
public class SettingsPage : UserControl
{
    ...
    private List<SettingsSection> CreateSections()
    {
        ...
        [
            ...
            new SettingsItem(Se.Language.Options.Settings.WaveformSingleClickOffsetSelected,
                () => UiUtil.MakeComboBox(_vm.Modifiers, _vm, nameof(_vm.WaveformSingleClickOffsetSelected))),
